...
if(isset($_POST['btn']) && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    updateProfileInformation($inputs, $photo, $user_id);
}
?>
...
<div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit your personal Information</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action='<?php echo htmlspecialchars($_SERVER['PHP_SELF']."?page=editProfile"); ?>' method='POST' enctype='multipart/form-data'>
                <div class="card-body">
